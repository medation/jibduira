...
export class AuthenticationService {
    ...
    public login(values: any): Observable<any> {
        return this.httpClient.post(`${SERVER_URL}/public/login`, values, {responseType: 'text'})
    ...
    public signup(values: any): Observable<any> {
        return this.httpClient.post(`${SERVER_URL}/public/registre`, values, {responseType: 'text'})
            .pipe(tap(jwt => {
                if (jwt !== 'EXISTS') {
